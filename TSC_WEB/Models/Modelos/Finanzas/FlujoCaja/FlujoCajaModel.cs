...
namespace TSC_WEB.Models.Modelos.Finanzas.FlujoCaja
{
    public class FlujoCajaModel
    {
        public async Task<IEnumerable<EFC_TipoPeriodo>> Get_TipoPeriodo()
        {
            try
            {
                using (var conexion = DBAccess.ObtenerConexionSQL())
                {
                    ...
                    var resultado = await conexion.QueryAsync<EFC_TipoPeriodo>("uspGetFlujoCaja",
                                                        sp_parametros,
        ...
        public async Task<IEnumerable<EFC_Periodo>> Get_Periodos(int tipoPeriodo)
        {
            try
            {
                using (var conexion = DBAccess.ObtenerConexionSQL())
                {
                    ...
                    var resultado = await conexion.QueryAsync<EFC_Periodo>("uspGetFlujoCaja",
                                                        sp_parametros,
                                                        commandType: CommandType.StoredProcedure);
                    return resultado;
                }
        ...
        public async Task<IEnumerable<EFC_FlujoCajaLista>> ListarFlujoCaja(int TipoPeriodo, int IdPeriodoIni, int IdPeriodoFin)
        {
            try
            {
                using (var conexion = DBAccess.ObtenerConexionSQL())
                {
                    ...
                    var resultado = await conexion.QueryAsync<EFC_FlujoCajaLista>("uspGetFlujoCaja",
                                                        sp_parametros,
                                                        commandType: CommandType.StoredProcedure);
                    return resultado;
                }
        ...
        public IEnumerable<EFC_FlujoCajaLista> ExpListarFlujoCaja(int TipoPeriodo, int IdPeriodoIni, int IdPeriodoFin)
        {
            try
            {
                using (var conexion = DBAccess.ObtenerConexionSQL())
                {
                    ...
                    var resultado = conexion.Query<EFC_FlujoCajaLista>("uspGetFlujoCaja",
                                                        sp_parametros,
                                                        commandType: CommandType.StoredProcedure);
                    return resultado;
                }
        ...
        public MemoryStream ExportarFlujoCaja(List<EFC_FlujoCajaLista> listado)
        {
            ...
            List<EFC_FlujoCajaLista> listaTmp = new List<EFC_FlujoCajaLista>();
            ...
            List<EFC_FlujoCajaLista> lstGrupo = new List<EFC_FlujoCajaLista>();
            List<classDistinctCptos> lstValidUlt = new List<classDistinctCptos>();
            List<EFC_FlujoCajaLista> lstSeccion = new List<EFC_FlujoCajaLista>();
                    ...
                    foreach (var item3 in listaTmp)
                    {
                        if (!lstConceptos.Exists(x => x.IdTipoAct == item3.efIdTipoAct && x.CodEFx == item3.efCodEFx && x.IdRSx == item3.efIdRSx && x.perorden == item3.efperorden))
                        {
                            foreach (var titulo in lstTitulo)
                            {
                                ...
                                {
                                    EFC_FlujoCajaLista objeto = listado.Find(x => x.efIdTipoAct == item3.efIdTipoAct && x.efCodEFx == item3.efCodEFx && x.efIdRSx == item3.efIdRSx && x.efperorden == item3.efperorden);
        ...
        public IEnumerable<EFC_ExcelDetalle> ListExcelDetFlujoCaja(int TipoPeriodo, int IdPeriodoIni, int IdPeriodoFin)
        {
            try
            {
                using (var conexion = DBAccess.ObtenerConexionSQL())
                {
                    ...
                    var resultado = conexion.Query<EFC_ExcelDetalle>("uspGetFlujoCaja",
                                                        sp_parametros,
                                                        commandType: CommandType.StoredProcedure);
                    return resultado;
                }
        ...
        public MemoryStream ExpExcelDetFlujoCaja(List<EFC_ExcelDetalle> listado)
        {
